...
public class hyposim4 {
    ...
    {
        try {
            writer = new FileWriter("Forgan_HW3Output.txt");    // Create a new file writer with output file name
        } catch (IOException e) {
    ...
    public static void main(String[] args) throws IOException{
        hyposim4 system = new hyposim4();    // Create a new instance of the class
